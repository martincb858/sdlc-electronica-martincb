...
# --- Tests de config.py ---
def test_uart_config_invalid_baudrate_raises_error():
...
def test_uart_config_is_immutable():
...
# --- Tests de parsers.py ---
def test_modbus_parser_valid_frame():
...
def test_nmea_parser_invalid_checksum():
    ...
    invalid_frame = b'$GPGGA,123519,4807.038,N,01131.000,E,1,08,0.9,545.4,M,46.9,M,,*99\r\n'
...
# --- Tests de device.py ---
def test_uart_device_read_not_connected_raises_error():
    ...
    with pytest.raises(RuntimeError, match="no está conectado"):
        device.read_and_parse(b'$GPGGA,123519,4807.038,N,01131.000,E,1,08,0.9,545.4,M,46.9,M,,*47\r\n')

# --- Tests de recorder.py ---
def test_data_recorder_writes_json_lines(tmp_path):
